...
# 1. Load series
dat <- read.csv("/Users/emilrand/Desktop/Uni/Bachelor/6. semester/BA_Emil/BA_repo/data/P_tv.csv")
...
write.csv(bsadf_stat, "/Users/emilrand/Desktop/Uni/Bachelor/6. semester/BA_Emil/BA_repo/data/bsadf/P_tv_bsadf_stat.csv", row.names = FALSE)

# BSADF critical values (90, 95, 99)
bsadf_cv <- as.data.frame(cv$bsadf_cv)        # keep all significance-level columns
write.csv(bsadf_cv, "/Users/emilrand/Desktop/Uni/Bachelor/6. semester/BA_Emil/BA_repo/data/bsadf/P_tv_bsadf_cv.csv", row.names = FALSE)